...
Pets.ward_hound = {
	...
	look = {
		...
		details = {
			...
			{
				name = "FrontPaw",
				size = Vector3.new(0.36, 0.22, 0.45),
				offset = Vector3.new(0.45, -0.82, -0.66),
				mirrored = true,
				colorKey = "secondary",
				material = "Fabric",
			},
			...
			{
				name = "BackPaw",
				size = Vector3.new(0.42, 0.24, 0.5),
				offset = Vector3.new(0.52, -0.82, 0.86),
				mirrored = true,
				colorKey = "secondary",
				material = "Fabric",
			},
	...
	look = {
		...
		details = {
			...
			},
			{
				...
				offset = Vector3.new(0, 0.48, -1.35),
			...
			{
				name = "TinyFoot",
				size = Vector3.new(0.18, 0.1, 0.24),
				offset = Vector3.new(0.3, -0.6, 0.48),
				mirrored = true,
			...
			},
			{
				...
				offset = Vector3.new(0.16, 0.22, -1.42),
				mirrored = true,
			...
			},
			{
				...
				offset = Vector3.new(1.3, 0.06, 0.14),
				mirrored = true,
				pitch = 0.18,
			...
			},
			{
				...
				offset = Vector3.new(1.72, 0.02, 0.3),
				mirrored = true,
				pitch = -0.18,
				color = Color3.fromRGB(62, 45, 44),
				material = "SmoothPlastic",
			},
			{
				...
				offset = Vector3.new(2.5, 0.14, -0.18),
				mirrored = true,
				color = Color3.fromRGB(62, 45, 44),
			},
		},
		...
		details = {
			{
				...
				offset = Vector3.new(1.18, 0.22, 0.2),
				mirrored = true,
				pitch = -0.08,
			...
			{
				name = "Foot",
				size = Vector3.new(0.22, 0.1, 0.42),
				offset = Vector3.new(0.28, -0.82, -0.42),
				mirrored = true,
			...
			{
				name = "Toe",
				size = Vector3.new(0.08, 0.06, 0.28),
				offset = Vector3.new(0.28, -0.83, -0.68),
				mirrored = true,
				color = Color3.fromRGB(218, 162, 70),
				material = "SmoothPlastic",
			},
			{
				name = "ShoulderMark",
				size = Vector3.new(0.34, 0.08, 0.34),
				offset = Vector3.new(0.72, 0.56, -0.2),
				mirrored = true,
				color = Color3.fromRGB(112, 132, 178),
			},
		},
